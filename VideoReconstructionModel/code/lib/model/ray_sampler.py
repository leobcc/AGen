...
class ErrorBoundSampler(RaySampler):
    ...
    def get_z_vals(self, ray_dirs, cam_loc, model, frame_encoding_vector, uv_static, cond, smpl_tfs, eval_mode, smpl_verts):
        ...
        while not_converge and total_iters < self.max_total_iters:
            ...
            with torch.no_grad():
                samples_sdf = model.sdf_func_with_smpl_deformer(points_flat, frame_encoding_vector, uv_static, cond, smpl_tfs, smpl_verts=smpl_verts)[0] 
